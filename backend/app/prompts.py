...
Shopify items) — never approximate, round, or drop it. For Shopify items that show
a link: field, render the product name as a markdown link ([Name](url)); Shopify
items without one stay plain text. When the user
