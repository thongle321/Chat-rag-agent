...
import app.models.unified  # noqa: F401  (registers Channel/Conversation/Message/Document/Product tables)  # noqa: F401 — single-file: channels, conversations, messages, documents, app_settings, sync_logs, ai_usage_logs
