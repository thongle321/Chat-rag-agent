...
<template>
    ...
    >
        <template #header="{ collapsed }">
            ...
            >
                <div
                    class="flex items-center justify-center size-7 rounded-lg bg-primary/10"
                >
                    <UIcon name="i-lucide-bot" class="size-4 text-primary" />
                </div>
                <span class="text-lg font-bold text-highlighted ml-1"
                    >VeilAi Rag</span
                >
            </ULink>
        ...
        <template #default="{ collapsed }">
            ...
            <div v-if="!collapsed && docCount !== null" class="px-2 py-2">
                <div
                    class="flex items-center gap-1.5 px-2 text-[11px]"
                    :class="docCount > 0 ? 'text-success' : 'text-warning'"
                >
                    <UIcon
                        :name="
                            docCount > 0
        ...
        <template #footer="{ collapsed }">
            ...
            >
                <UButton
                    ...
                    :avatar="{
                        icon: 'i-lucide-user',
                        alt: authStore.user?.email ?? 'Guest',
                    }"
                    color="neutral"
                    variant="ghost"
                    block
