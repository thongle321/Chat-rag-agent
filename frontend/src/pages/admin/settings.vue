...
const activeTab = ref<"provider" | "integration">("provider");
...
<template>
    <UDashboardPanel id="settings" :ui="{ body: 'lg:py-8' }">
        ...
        <template #body>
            <div
                class="flex flex-col lg:flex-row gap-6 max-w-5xl mx-auto w-full"
            >
                <!-- Left: 2 tabs -->
                <UCard class="lg:w-56 shrink-0 h-fit">
                    <UNavigationMenu
                            ...
                            [
                                {
                                    ...
                                    onSelect: () => (activeTab = 'provider'),
                                },
                                {
                                    label: 'Integration',
                                    icon: 'i-lucide-plug',
                                    active: activeTab === 'integration',
                                    onSelect: () => (activeTab = 'integration'),
                                },
                            ],
                        ]"
                    />
