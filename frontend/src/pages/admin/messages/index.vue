...
<template>
  <UDashboardPanel id="messages">
    ...
    <template #body>
      ...
      <div v-else-if="!channels.length" class="flex flex-col items-center py-16 max-w-lg mx-auto text-center">
        <UIcon name="i-lucide-plug" class="size-12 text-muted mb-4" />
        <h3 class="text-lg font-semibold">No channels connected</h3>
        <p class="text-sm text-muted mt-2">Connect to <b>Integrations</b> to see the messages.</p>
        <UButton to="/admin/integrations" icon="i-lucide-plug" class="mt-6">Go to Integrations</UButton>
      </div>
